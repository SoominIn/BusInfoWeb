...
<br></br><br></br>
 ...
 <body>
   <div id="section1">
    ...
    <h1><th>Passing Through</th></h1>
     <?php
       $st_name = $_POST[ 'st_name' ];
       $bus_region = $_POST[ 'bus_region' ];
       $jb_conn = mysqli_connect( 'localhost', 'root', 'root', 'app' );
       $jb_sql = "SELECT distinct bus_number FROM busstation WHERE st_name = '$st_name' and bus_region = '$bus_region'ORDER BY bus_number ASC ";
     ...
     <thead align = "center">     
     <tr>  
     <td width = "300" align = "center">bus number</td>
     </tr>
     </thead>
        <tbody>
        <?php
        ...
        ?>                      <tr>
                ...
                <td width = "300" align = "center"><?php echo $rows['bus_number']?></td>
                </tr>
        <?php
                $total--;
                }
