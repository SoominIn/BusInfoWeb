...
<?php
                ...
                $number = $_GET['number'];
                session_start();
                $query = "select title, content, date, id from notice where number =$number";
        ...
        <!-- MODIFY & DELETE -->
        <div class="view_btn">
                <button class="view_btn1" onclick="location.href='Notice.html'">목록으로</button>
                <button class="view_btn1" onclick="location.href='push_notification.php'">PUSH</button>
        </div>
